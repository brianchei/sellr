    ...
    return (
      <main className="mx-auto max-w-4xl px-4 py-10">
        <section className="rounded-lg border border-[var(--border-default)] bg-white p-6 shadow-sm">
          ...
          <Link
            href="/onboarding"
            className="mt-5 inline-flex rounded-lg bg-[var(--color-primary-600)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--color-primary-700)]"
          >
            Join community
          </Link>
        </section>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="m-3 rounded-full bg-white/95 px-3 py-1 text-xs font-medium text-[var(--text-primary)] shadow-sm">
                    {listing.category}
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    {listing.negotiable ? (
                      <span className="rounded-full bg-[var(--color-accent-100)] px-2.5 py-1 text-xs font-medium text-[var(--color-accent-700)]">
                        Negotiable
                      </span>
                    ) : null}
